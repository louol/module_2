...
class Circle(Figure):
    ...
    def get_square(self):
        area_of_circle = (self.__radius ** 2) * pi
...
class Triangle(Figure):
    ...
    def get_square(self):
        ...
        area_of_triangle = sqrt(p * (p - self.sides[0]) * (p - self.sides[1]) * (p - self.sides[2]))
...
class Cube(Figure):
    ...
    def get_volume(self):
        volume_of_cube = self.__sides[0] ** 3
        return volume_of_cube

circle1 = Circle((200, 200, 100), 10) # (Цвет, стороны)
cube1 = Cube((222, 35, 130), 6)
triangle1 = Triangle((146, 76, 32), 9, 4, 7)
